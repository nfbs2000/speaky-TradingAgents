...
| Claude Code 트레이딩 팀과 스킬 | [12장: Claude Code 트레이딩 팀과 스킬](part5/ch12-claude-team-skills.md) | [`.claude/TEAM.md`](https://github.com/nfbs2000/speaky-TradingAgents/blob/main/.claude/TEAM.md), [`.claude/agents/`](https://github.com/nfbs2000/speaky-TradingAgents/tree/main/.claude/agents), [`.claude/skills/ta-team-analysis/`](https://github.com/nfbs2000/speaky-TradingAgents/tree/main/.claude/skills/ta-team-analysis), [Claude 팀 공개 페이지](https://nfbs2000.github.io/speaky-TradingAgents/claude-team/) |
| Claude Code 트레이딩 워크플로우 | [13장: Claude Code 트레이딩 워크플로우](part5/ch13-claude-workflow.md) | [`.claude/workflows/ta-team-run.js`](https://github.com/nfbs2000/speaky-TradingAgents/blob/main/.claude/workflows/ta-team-run.js), [`.claude/workflows/ta-watchlist-run.js`](https://github.com/nfbs2000/speaky-TradingAgents/blob/main/.claude/workflows/ta-watchlist-run.js), [최신 NVDA 팀런](https://github.com/nfbs2000/speaky-TradingAgents/tree/main/.claude/team-runs/2026-08-02-NVDA) |
...
| 12 | 현재 `.claude`는 트레이딩 실행 전용 팀이며, 저장소 `@tool` 계산과 Claude 해석을 분리한다. |
| 13 | 워크플로우는 P0 시장 데이터 고정 → 병렬 애널리스트 → 리스크 종합 → 최종 리포트를 실행 순서로 묶는다. |
